...
int main (int argc, char ** argv) {
    ...
    eff_geom = MC(L, l, h1, h2, h3, d1, d2, N_MC, M, NBin, Layout, trim(Dir), suffix.str());
    /*    
    for (int a1 = 0; a1 < 3; a1++) {
        ...
        for (int a2 = 0; a2 < 3; a2++) {
            ...
            for (int a3 = 0; a3 < 3; a3++) {
                ...
                cout << "Start simulations cycle " << counter << "/27" << endl;
                
                stringstream ss;
                ss << "_" << a1-1 << a2-1 << a3-1;
                
                eff_geom = MC(L, l,  z1 + a1 * h1/2,  z2 + a2 * h2/2,  z3 + a3 * h3/2, d, N_MC, M, NBin, ss.str(), Layout);
